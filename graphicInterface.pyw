...
def calcular():
    ...
    if(mes=="Enero"):
        ...
        algoritmoFebrero(cu,c,d,dicppv,dicpload,dicPrem,bateria)
    elif(mes=="Marzo"):
        algoritmoMarzo(cu,c,d,dicppv,dicpload,dicPrem,bateria)
    elif(mes=="Abril"):
        algoritmoAbril(cu,c,d,dicppv,dicpload,dicPrem,bateria)
    elif(mes=="Mayo"):
        algoritmoMayo(cu,c,d,dicppv,dicpload,dicPrem,bateria)
    elif(mes=="Junio"):
        algoritmoJunio(cu,c,d,dicppv,dicpload,dicPrem,bateria)
    elif(mes=="Julio"):
        algoritmoJulio(cu,c,d,dicppv,dicpload,dicPrem,bateria)
    elif(mes=="Agosto"):
        algoritmoAgosto(cu,c,d,dicppv,dicpload,dicPrem,bateria)
    elif(mes=="Septiembre"):
        algoritmoSeptiembre(cu,c,d,dicppv,dicpload,dicPrem,bateria)
    elif(mes=="Octubre"):
        algoritmoOctubre(cu,c,d,dicppv,dicpload,dicPrem,bateria)
...
labelCu = Label(frame, text="Costo unitario:")
...
labelC = Label(frame, text="Comercialización:")
...
labelD = Label(frame, text="Distribución:")
...
labelppv = Label(frame, text="Insolación::")
...
labelpLoad = Label(frame, text="Carga:")
